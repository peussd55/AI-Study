...
best_score : 0.31436054584661033
model.score : 0.49570790755602223
r2_score : 0.49570790755602223
best_r2_score : 0.49570790755602223
걸린시간 : 5 초
"""
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm18_ rs_cv_results_03_diabetes.csv')

# 5. 가중치 저장
path = './_save/m18_cv_results/'
joblib.dump(model.best_estimator_, path + 'm18_best_model_03_diabetes.joblib')
