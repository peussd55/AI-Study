...
그때 r2 : 0.8265854485306885
그때 남아있는 컬럼의 갯수 : 7
verbose : 0

PolynomialFeatures 적용여부 : 1
최대의 r2보장하면서 가장 많이 삭제된 컬럼 리스트 : ['1', 'HouseAge', 'AveRooms', 'AveBedrms', 'Population', 'AveOccup', 'MedInc^2', 'MedInc AveRooms', 'MedInc Population', 'MedInc AveOccup', 'MedInc Latitude', 'HouseAge^2', 'HouseAge AveRooms', 'HouseAge AveBedrms', 'HouseAge Population', 'HouseAge AveOccup', 'HouseAge Latitude', 'HouseAge Longitude', 'AveRooms^2', 'AveRooms AveBedrms', 'AveRooms Population', 'AveRooms Latitude', 'AveRooms Longitude', 'AveBedrms^2', 'AveBedrms Population', 'AveBedrms AveOccup', 'AveBedrms Latitude', 'AveBedrms Longitude', 'Population^2', 'Population AveOccup', 'Population Latitude', 'Population 
Longitude', 'AveOccup^2', 'AveOccup Longitude', 'Latitude^2']
그때 r2 : 0.8225270354434956
그때 남아있는 컬럼의 갯수 : 10
verbose : 0
