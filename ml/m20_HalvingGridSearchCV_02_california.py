...
best_score : 0.14635939658444524
model.score : 0.14780442631452506
r2_score : 0.14780442631452506
best_r2_score : 0.14780442631452506
걸린시간 : 112 초
-> 데이터가 적어서 GridSearchCV보다 성능이 확연히 떨어진다.
"""
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm20_ hgs_cv_results_02_california.csv')

# 5. 가중치 저장
path = './_save/m20_cv_results/'
joblib.dump(model.best_estimator_, path + 'm20_best_model_02_california.joblib')