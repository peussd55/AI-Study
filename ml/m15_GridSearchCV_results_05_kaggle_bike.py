...
best_score : 0.3557015895843506
model.score : 0.34201836585998535
r2_score : 0.34201836585998535
걸린시간 : 28 초
"""
# 결과 csv출력 생성
import pandas as pd
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm15_gs_cv_results_05_kaggle_bike.csv')