...
### SMOTENC : 라벨형데이터의 거리계산을하고 값을 부여하는게 아니라 투표를 해서 라벨을 부여
...
smotenc = SMOTENC(random_state=337,
                  categorical_features=[3,4]  # 몇번째 범주형 컬럼들을 smotenc할것인지
                  )
...
print(x_res['Geography'].value_counts())
# 0    145026
# 1     74936
# 2     40264

print(x_res['Gender'].value_counts())
# 0    149478
# 1    110748
...
[SMOTENC]
loss :  0.2818678915500641
acc :  0.8762232661247253
accuracy :  0.8762232925142184
걸린시간 : 302.0789759159088 초

[그냥]
loss :  0.3235934376716614
acc :  0.8635252714157104
accuracy :  0.8635252772111248
걸린시간 : 104.03403234481812 초
"""
