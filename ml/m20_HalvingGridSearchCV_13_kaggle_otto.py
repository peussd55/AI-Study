...
[1. factor : 3 (default), min_resources : default]
    n_iterations: 4
...
[1. factor : 12 (default), min_resources : default]    
    n_iterations: 2
...
"""
[factor : 3 (default), min_resources : default]
최적의 파라미터 : {'learning_rate': 0.1, 'max_depth': 10, 'n_estimators': 500}
best_score : 0.821225860144087
model.score : 0.8228021978021978
accuracy_score : 0.8228021978021978
accuracy_score : 0.8228021978021978
걸린시간 : 372 초
-> GridSearchCV 대비 속도,성능 up

[factor : 12 (default), min_resources : default]
최적의 파라미터 : {'learning_rate': 0.1, 'max_depth': 10, 'n_estimators': 500}
best_score : 0.8211811436927106
model.score : 0.8228021978021978
accuracy_score : 0.8228021978021978
accuracy_score : 0.8228021978021978
걸린시간 : 348 초
...
path = './_save/m20_cv_results/'
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm20_hgs_cv_results_13_kaggle_otto.csv')

# 5. 가중치 저장
path = './_save/m20_cv_results/'
joblib.dump(model.best_estimator_, path + 'm20_best_model_13_kaggle_otto.joblib')