...
print('r2 :', model.score(x_test, y_test))     # r2 : 0.7632837109221342
r2 = model.score(x_test, y_test)
print(model.feature_importances_)
    
print("25%지점 :",np.percentile(model.feature_importances_, 25))   # 25% 지점확인
# 25%지점 : 0.028086617588996887
...
print('그냥 한거 r2 :', r2)       # 그냥 한거 r2 : 0.7632837109221342
...
for i in range(1, com_len):
    ...
    # (1167, 3) (292, 3)
    # (1167, 7) (292, 7)
    # FI_Drop + PCA : 0.7564628556944498
    # ============ n_component가 2 일때 ================
    # (1167, 3) (292, 3)
    # (1167, 8) (292, 8)
    # FI_Drop + PCA : 0.7450880304281899