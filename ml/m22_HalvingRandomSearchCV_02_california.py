...
best_score : 0.07932488835526748
model.score : 0.12267131590430591
r2_score : 0.12267131590430591
best_r2_score : 0.12267131590430591
걸린시간 : 6 초
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm22_ hrs_cv_results_02_california.csv')

# 5. 가중치 저장
path = './_save/m22_cv_results/'
joblib.dump(model.best_estimator_, path + 'm22_best_model_02_california.joblib')