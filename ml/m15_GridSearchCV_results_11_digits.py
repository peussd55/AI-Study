...
best_score : 0.9638114595431668
model.score : 0.9722222222222222
r2_score : 0.9722222222222222
걸린시간 : 29 초
"""
...
pd.DataFrame(model.cv_results_).sort_values('rank_test_score', ascending=True).to_csv(path + 'm15_gs_cv_results_11_digits.csv')