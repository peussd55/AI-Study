...
class RNN(nn.Module):
    def __init__(self):
        ...
        self.rnn_layer2 = nn.RNN(32, 20, batch_first=True)  # (N, 3, 32)
        
        # self.fc1 = nn.Linear(3*20, 16)    # timesteps * feature : 이렇게해도 오류는 나지 않으나 시간의 순서가 무시되어 학습된다.
        self.fc1 = nn.Linear(20, 16)        # 과적합방지위해 timestep을 제거(시간의 순서가 무시되는 문제 제거)
...
# [8, 9, 10]의 예측값: 10.399932861328125
