...
class RNN(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(3*32*2, 16)    # timesteps * feature : 이렇게해도 오류는 나지 않으나 시간의 순서가 무시되어 학습된다.
...
# ==========================================================================================
# RNN                                      [2, 1]                    --
# ├─RNN: 1-1                               [2, 3, 64]                2,240
# ├─ReLU: 1-2                              [2, 3, 64]                --
# ├─Linear: 1-3                            [2, 16]                   3,088
# ├─Linear: 1-4                            [2, 8]                    136
# ├─ReLU: 1-5                              [2, 8]                    --
# ├─Linear: 1-6                            [2, 1]                    9
# ==========================================================================================
...
# [8, 9, 10]의 예측값: 10.65699291229248
