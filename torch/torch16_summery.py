...
###ttr.normailze((0.5 ,0.5))
# z_sore normalization 정규화의 표군화
# (x-평균)/ 평균표차
# (x-0.5)/0.5 위 식처럼 해야하는데 통상평균 0.5, 표편 0.5로 계산하면
# -1~1 사이의 범위가 나오나 이미지 전처리에서는 통상 0.5,0.5 한다.
...
print(model) # 해당 내용은 forward의 내용이 아니라 init에 해당 하는 내용 출력
