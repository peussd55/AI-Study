...
data_type = 'binary_classification'
########################## 랜덤고정 & 쿠다확인 & 데이터종류명시 ##########################
...
# torch.Size([140000, 200]) torch.Size([140000, 1])
# torch.Size([60000, 200]) torch.Size([60000, 1])
...
""" 
걸린시간 : 311.4665746688843 초
최종 loss : 1.4077176849047344
acc : 0.8792333333333333
"""