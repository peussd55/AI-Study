...
print(train_dataset[0])             # (<PIL.Image.Image image mode=L size=28x28 at 0x1D613D64D30>, 9)
...
# shape 확인
# .to(DEVICE)는 모델구현부분에서 직접명시 / .to(DEVICE) 의미 : 데이터르 gpu메모리로 전송
print("==================== 최종 shape ====================")
...
"""
걸린시간 : 47.48723030090332 초
최종 loss : 0.3887882654706891
최종 acc : 0.8611222044728435
acc : 0.8611
"""