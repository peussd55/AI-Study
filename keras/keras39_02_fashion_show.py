...
# 2. 모델구성
model = Sequential()
model.add(Conv2D(256, (3,3), strides=1, input_shape=(28, 28, 1), activation='relu'))                        # (None, 26, 26, 64)
model.add(MaxPool2D())                                                                  # (None, 13, 13, 64) : 디폴트는 반만큼 줄인다
model.add(Conv2D(filters=128, kernel_size=(3,3), activation='relu'))                     # (None, 11, 11, 64)
