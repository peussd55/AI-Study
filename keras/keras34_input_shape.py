...
for scaler_name, scaler in scalers:
    ...
    model.add(Dense(100, input_shape=(13,)))    # 훈련할때는 데이터(행)갯수는 중요하지 않다.
    # (10000, 10, 3) 데이터를 훈련한다면
    # model.add(Dense(100, input_shape=(10, 3))) 
...
loss : 17.81537437438965
RMSE : 4.220826433996158
r2 스코어 : 0.795218907422572

=== 현재 적용 스케일러(dropout O): None ===
loss : 34.675167083740234
RMSE : 5.888562171249725
r2 스코어 : 0.6014219320653416
