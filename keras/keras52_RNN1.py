...
# model.add(SimpleRNN(256, input_shape=(3, 1), activation='relu'))    # 행 무시 열 우선 : 7 = batch = 데이터갯수 = 행
model.add(SimpleRNN(units=512, input_shape=(3, 1), activation='relu'))        # RNN, Dense 는 units, cnn은 feature
# model.add(LSTM(units=512, input_shape=(3, 1)))
