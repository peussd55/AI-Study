...
end1 = time.time()
print('배치업로드 완료시간 :', round(end1-start, 2), '초')  # 배치업로드 완료시간 : 1.09 초
...
end2 = time.time()
print('변환시간 :', round(end2-start, 2), '초')     # 변환시간 : 78.87 초
...
# x.sahpe :  (25000, 250, 250, 3)
# y.sahpe :  (25000,)
end3 = time.time()
print('numpy 배열 합체 시간 :', round(end3-start, 2), '초')    
