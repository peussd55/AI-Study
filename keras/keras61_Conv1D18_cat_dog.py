...
# 참고: 원본 코드의 input_shape(50,50,3)에 맞춰 해당 npy파일을 사용해야 합니다.
# x_train_load = np.load(np_path + "keras44_01_x_train_50.npy") # 예시
# y_train_load = np.load(np_path + "keras44_01_y_train_50.npy") # 예시
# submission_x_load = np.load(np_path + 'keras44_01_x_submission_50.npy') # 예시
...
model = Sequential()
model.add(Conv1D(filters=64, kernel_size=5, input_shape=(num_features, 1), activation='relu'))
