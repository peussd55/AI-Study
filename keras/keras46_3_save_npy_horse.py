...
path_train = './_data/tensor_cert/horse-or-human/'
...
print(len(xy_train))       
end1 = time.time()
print('배치업로드 완료시간 :', round(end1-start1, 2), '초')  # 배치업로드 완료시간 :  1.2 초
...
print('x.sahpe : ', x.shape)    # (1027, 200, 200, 3)
print('y.sahpe : ', y.shape)    # (1027,)
...
np.save(np_path + 'keras46_03_x_train.npy', arr=x)
np.save(np_path + 'keras46_03_y_train.npy', arr=y)

end4 = time.time()

print('npy 저장시간 :', round(end4-start4, 2), '초')        # npy 저장시간 : 1.27 초
