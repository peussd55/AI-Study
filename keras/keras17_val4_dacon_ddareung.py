...
model.fit(x_train, y_train, epochs=2, batch_size=32, validation=0.1)
...
print('RMSE 값 :', rmse)
"""
평균값 넣기 :: r2 스코어 : 0.6183719787960575 / loss : 2800
삭제 :: r2 스코어 :  0.6420231056818644 / loss 값 : 2683.690185546875
RMSE :: 52.335112428611886
# relu 썻을때
