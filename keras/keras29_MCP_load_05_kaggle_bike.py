...
model = load_model(path + 'k28_0604_1204_0357-23418.4043.hdf5')      # restore_best_weights=True일때 저장한 모델과 가중치 동일
# loss 값 : 22183.578125
# r2 스코어: 0.29990500021270095
# rmse 스코어: 148.94151912183733
...
batch_size=24, 
loss 값 : 24011.015625
r2 스코어: 0.2422325846247666
rmse 스코어: 154.95487867531145
Competition Score : 1.38630
...
batch_size=24, 
stop지점 : 375,
loss 값 : 21677.3671875
r2 스코어: 0.3158804387311124
rmse 스코어: 147.23236744246503
Competition Score : 1.33933
...
batch_size=24, 
stop지점 : 464,
loss 값 : 22408.580078125
r2 스코어: 0.2928039686212709
rmse 스코어: 149.6949669066804
Competition Score : 1.36174
"""