...
x_augmented = datagen.flow(
    ...
    shuffle=False,
    save_to_dir='c:\\study25\\_data\\_save_img\\03_cifar10\\',  # 증폭데이터 저장경로
).next()[0] #튜플에서 x만 추출
exit()
...
print(y_train.shape, y_test.shape)  # (75000, 10) (10000, 10)

# 2. 모델구성
model = Sequential()
model.add(Conv2D(64, (3,3), strides=1, input_shape=(32, 32, 3)))    # (32, 32, 3) 에서의 채널(1 또는 3)은 여기서만 쓰이고 다음 레이어부터는 filters를 입력받는다. 
