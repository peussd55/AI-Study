...
# (15,5) Conv1D모델구성 (토크나이징O, 패딩O, 원핫X, 임베딩X)
...
padding_x_pred = padding_x_pred.reshape(-1, padding_x_pred.shape[1], 1)
print(padding_x_pred.shape) # (1, 5, 1)
print(padding_x_pred)
# [[[0]
#   [0]
#   [1]
#   [2]
