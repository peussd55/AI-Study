...
for scaler_name, scaler in scalers:
    ...
    # 2. 모델구성
    model = Sequential()
    model.add(LSTM(64, input_shape=(13,1))) # (None, 64) 
    model.add(Dense(11))
    model.add(Dense(12))
    model.add(Dense(13))
    model.add(Dense(1))
    ...
    print('훈련 직전 x_train의 형태:', x_train.shape)   # (404, 13)
    ...
    print('loss :', loss)
    print('results :', results.shape)   # (102, 1)
    from sklearn.metrics import r2_score, mean_squared_error
...
"""
    ...
    - LSTM
    === 현재 적용 스케일러: None ===
    loss : 18.175046920776367
    RMSE : 4.263220145631326
    r2 스코어 : 0.7910846324926744
