...
path = './_save/keras26/'
model = load_model(path + 'keras26_3_save.h5')  # random_state 달라지면 스코어도 달라지지만 어차피 대회제출할때는 주어진 테스트데이터(test_csv)로만 predict하므로 달라지지않는다.
...
# RMSE : 4.3280565668586295
# r2 스코어 : 0.7846818078075273    \
