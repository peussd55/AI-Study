...
print(y.shape)  # (3, 10) -> (10, 3) : output의 컬럼은 3개 -> 읽는법(Nan by two) : 행의 갯수는 중요하지 않아서 Nan이라고 읽고 ,는 by라고 읽는다.
...
model.add(Dense(6))
model.add(Dense(4))
model.add(Dense(3))    # y의 컬럼이 3이기때문에 출력레이어의 Dense는 3로 지정하여야한다.
# y컬럼이 1일 경우에는 출력레이어 Dense가 1이 아니어도 브로드캐스팅되어(y를 차원 확장 : [1] -> [1,1]) 같은 결과 값을 여러번 출력하지만 
...
# [10, 31, 211], [11,32,212]의 예측값 : [[ 1.0999984e+01  1.6989186e-05 -9.9998951e-01]
#  [ 1.1999988e+01 -9.9998397e-01 -1.9999850e+00]]