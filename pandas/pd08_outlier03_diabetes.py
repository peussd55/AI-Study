...
# [그냥]
# r2_score : 0.904486119747161

# [이상치처리-중위값]
# r2_score : 0.8916613459587097

# [이상치처리-평균값]
# r2_score : 0.8821339011192322

# [이상치처리-경계값처리]
# r2_score : 0.8814716935157776

# -> 데이터가 적거나 이상치가 적을때 이상치처리하면 오히려 성능 다운되는 현상이있다.